---
title: "Tramore (IRE) | Monday 01 January 2024"
course: Tramore (IRE)
image: course.png
featured: false
order: 0
...
```
Todays Racecard for Tramore (IRE) including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Tramore (IRE)") %>% select(QueryID) %>% distinct()
