---
title: "Lingfield | Tuesday 05 March 2024"
course: Lingfield
image: course.png
featured: false
order: 0
...
```
Todays Racecard for Lingfield including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Lingfield") %>% select(QueryID) %>% distinct()
