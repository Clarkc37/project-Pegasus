---
title: "Navan (IRE) | Saturday 23 March 2024"
course: Navan (IRE)
image: course.png
featured: false
Date: 2024-03-23
...
```
Todays Racecard for Navan (IRE) including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Navan (IRE)") %>% select(QueryID) %>% distinct()
