---
title: "Bangor-On-Dee | Wednesday 28 February 2024"
...
```
Todays Racecard for Bangor-On-Dee including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Bangor-On-Dee") %>% select(QueryID) %>% distinct()
