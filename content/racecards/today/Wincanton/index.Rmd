---
title: "Wincanton | Wednesday 28 February 2024"
course: Wincanton
image: course.png
featured: false
order: 0
...
```
Todays Racecard for Wincanton including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Wincanton") %>% select(QueryID) %>% distinct()
