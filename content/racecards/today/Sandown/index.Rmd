---
title: "Sandown | Thursday 15 February 2024"
course: Sandown
image: course.png
featured: true
order: 0
...
```
Todays Racecard for Sandown including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Sandown") %>% select(QueryID) %>% distinct()
