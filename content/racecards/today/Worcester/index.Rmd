---
title: "Worcester | Friday 29 September 2023"
course: Worcester
image: course.png
output:
  html_document:
...
```
Todays Racecard for Worcester including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Worcester") %>% select(QueryID) %>% distinct()
