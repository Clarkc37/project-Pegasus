---
title: "Thurles (IRE) | Tuesday 05 March 2024"
course: Thurles (IRE)
image: course.png
featured: true
order: 0
...
```
Todays Racecard for Thurles (IRE) including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Thurles (IRE)") %>% select(QueryID) %>% distinct()
