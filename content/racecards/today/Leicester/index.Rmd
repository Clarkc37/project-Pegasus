---
title: "Leicester | Wednesday 10 January 2024"
course: Leicester
image: course.png
featured: false
order: 0
...
```
Todays Racecard for Leicester including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Leicester") %>% select(QueryID) %>% distinct()
