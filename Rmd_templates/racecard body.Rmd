Todays Racecard for Course_Placeholder including algorithm predictions and confidence %
...
i <- 1
Index <- Todays.Prediction %>% filter(Course=="Course_Placeholder") %>% select(QueryID) %>% distinct()
